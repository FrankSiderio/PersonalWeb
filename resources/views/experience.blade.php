        ...
        <div class="container">
            <div class="left-right">
                <div class="content">
                    ...
                    <p>The past two summers I was on the mobile app team. My first summer I worked on mainly supporting the app. I created test scripts in Postman to test mobile ordering and worked a lot in MySql. My second summer I worked with developers on features and bug fixes. I even was apart of creating a test app for geofence testing. I gained experience with Postman, MySql, AWS, Android Studio, APIs, Java, and Retrofit.</p>
        ...
        <div class="container">
            <div class="left-right">
                <div class="content">
                    ...
                    <p>As the liason between the student body and Marist IT it is one of my duties to handle technology issues on campus. I lead a team who are responsible for improving and supporting the software applications for SGA and Student Activities. We support applications like our club management system, club websites, parking appeals, and our website. My team has developers, QA Testers, and Designers. We work with Linux, Apache, MySql, and PHP.</p>
                    <div class="button-container">
        ...
        <div class="container">
            <div class="left-right">
                <div class="content">
                    ...
                    <p>As an instructor at iD Tech I was able to teach kids about technology. I taught classes on how to program with JavaScript. Creating different skins and models in minecraft. And my favorite, I taught a Minecraft modding class.</p>
                    <div class="button-container">
